...
SET @new_value = '15.0.2000.5'     -- This will be replaced at build time with the sql build number
...
BEGIN
    ...
    IF (@old_value_char <> '15.0.2000.5')   -- value only used during development
    BEGIN
